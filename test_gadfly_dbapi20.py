...
#         assert str(gadfly.Date(1234,12,21)) == '1234-12-21'
#         assert str(gadfly.Date(34,2,4)) == '0034-02-04'
#         assert str(gadfly.Time(0,1,2)) == '00:01:02'
#         assert str(gadfly.Time(24,1,2)) == '24:01:02'
#         assert str(gadfly.Timestamp(1234,12,21,0,1,2)) == \
#                 '1234-12-21 00:01:02'
#         assert str(gadfly.Timestamp(34,2,4,24,1,2)) == \
#             '0034-02-04 24:01:02'

#         # Add 8 hours, 21 mins and 2 secs as midnight isn't a good test
#         groundhog_day = 1044144000 + 8*60*60 + 21*60 + 2
#         assert str(gadfly.DateFromTicks(groundhog_day)) == '2003-02-02'
#         assert str(gadfly.TimeFromTicks(groundhog_day)) == '08:21:02'
#         assert str(gadfly.TimestampFromTicks(groundhog_day)) == \
#                 '2003-02-02 08:21:02'
